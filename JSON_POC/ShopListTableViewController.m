...
//  JSON_POC
//
//  Created by Adam Cheung on 7/6/14.
...
- (void)viewDidLoad
{
    ...
    _shops  = [NSMutableArray arrayWithCapacity:10];
    
    Shop *shop = [[Shop alloc] init];
    shop.shopName = @"ParkNShop";
    shop.updateDate = nowString;
    [_shops addObject:shop];
    
    shop = [[Shop alloc] init];
    shop.shopName = @"Wellcome";
    shop.updateDate = nowString;
    [_shops addObject:shop];
